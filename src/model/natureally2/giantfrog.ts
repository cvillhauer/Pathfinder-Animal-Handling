...
export class GiantFrog extends Animal{
    ...
    constructor(name: string, rounds: number) {
        ...
        this.abilities = ["low-light vision", "scent", "reach 15ft", "swim 30ft"];
        this.skills = ["Acrobatics +9", "Perception +3", "Stealth +5", "Swim +10"];
        this.armorclass = 12;
        this.attack = ["Bite +3 1d6+2 plus grab", "Tongue +3 touch grab", "Pull 5ft", "Swallow Whole 1d4, 1hp", "Grapple +7"];
        this.speed = 30;
