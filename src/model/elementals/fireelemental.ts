...
export class FireElemental extends Elemental {
    ...
    calculateStatsSmall() {
        ...
        this.armorclass = 16;
        this.attack = ["Slam +4 1d4 plus burn", "Burn DC 11 1d4 for 1d4 rounds"];
    ...
    calculateStatsMedium() {
        ...
        this.armorclass = 17;
        this.attack = ["Slam +7 1d6+1 plus burn", "Burn DC 16 1d6 for 1d4 rounds"];
    ...
    calculateStatsLarge() {
        ...
        this.armorclass = 19;
        this.attack = ["Slam +12 1d8+2 plus burn", "Slam +12 1d8+2 plus burn", "Burn DC 16 1d8 for 1d4 rounds"];
    ...
    calculateStatsHuge() {
        ...
        this.armorclass = 21;
        this.attack = ["Slam +15 2d6+4 plus burn", "Slam +15 2d6+4 plus burn", "Burn DC 18 2d6 for 1d4 rounds"];
        this.speed = 60;
    ...
    calculateStatsGreater() {
        ...
        this.armorclass = 23;
        this.attack = ["Slam +19 2d8+7 plus burn", "Slam +19 2d8+7 plus burn", "Burn DC 20 2d8 for 1d4 rounds"];
        this.speed = 60;
    ...
    calculateStatsElder() {
        ...
        this.armorclass = 26;
        this.attack = ["Slam +23 2d8+8 plus burn", "Slam +23 2d8+8 plus burn", "Burn DC 22 2d10 for 1d4 rounds"];
        this.speed = 60;
