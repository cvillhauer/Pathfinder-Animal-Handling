...
export class Elemental extends Creature {
    ...
    constructor(name: string, rounds: number, element: Element, elementalType: ElementalType) {
        ...
        this.abilities = ["immune to bleed", "immune to paralysis", "immune to poison", "immune to sleep and stun", "immune to critical hits", "immune to flanking", "immune to sneak attacks", "darkvision 60ft"];
    }
