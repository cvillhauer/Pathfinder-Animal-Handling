...
define(["require", "exports", "knockout", "../enums", "../animal"], function (require, exports, ko, enums_1, animal_1) {
    ...
    var GiantAnt = /** @class */ (function (_super) {
        __extends(GiantAnt, _super);
        function GiantAnt(name, rounds) {
            var _this = _super.call(this, name, rounds) || this;
            _this.description = "Giant Ant - Soldier";
            ...
            _this.armorclass = 15;
            _this.attack = ["Bite +3 1d6+2 plus grab", "Grapple +7", "Sting +3 1d4+2", "Poison DC 14 1d2 Str"];
            _this.speed = 50;
            _this.cmb = 3;
            _this.cmd = 13;
            _this.fort = 6;
...
//# sourceMappingURL=giantant.js.map